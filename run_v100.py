"""Run all benchmarks and validation for NVIDIA V100.
Note: V100 is the only GPU where FP64 is practical (1:2 ratio).
Supports full grids up to 6400x2080 in both FP32 and FP64.
"""
import sys, os
