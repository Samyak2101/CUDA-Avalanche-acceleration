...
Features
    ...
    2D Eulerian Solver (Dynamic-k Rusanov): Implements a first-order Rusanov scheme on a fixed spatial grid. Features a dynamic Earth pressure coefficient (kact​ and kpass​) based on the local velocity divergence field.
